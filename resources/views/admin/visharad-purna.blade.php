...
<div class="card">
            <div>
                <div class="col-md-9" style="float:left; clear:both;">
                    <h3>Syllabus For Visharad Purna</h3>
                </div>
                <div class="col-md-3" style="float:left;">
                    <button class="btn btn-secondary form-control" onclick="redirectToSyllabus('Visharad_Purna')" id="prarmbhik-upload-btn" style="width: auto; float: right;">Upload New Syllabus</button>
                </div>
            </div>
