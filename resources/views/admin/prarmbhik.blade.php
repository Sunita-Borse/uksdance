...
<!--style>
    ...
    .action-column {
     ...
     @media (max-width: 768px) {
        .heading, .table-row, .table-header {
            flex-direction: column;
        }

        .col, .email-col, .dob-col, dob-col-dance{
            border-right: none; /* Remove right border for all columns */
        }
...
<div id="syllabusTable" class="table-container">
    <div class="table-header">
        <div class="column">Exam Year</div>
    ...
    <div class="table-row">
        <div class="column">{{ $syllabus->exam->label() }}</div>
